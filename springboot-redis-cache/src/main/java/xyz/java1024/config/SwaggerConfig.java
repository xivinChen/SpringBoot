...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).extensions(getExtension())
                .apiInfo(getApiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("xyz.java1024.controller"))
    ...
    private ApiInfo getApiInfo() {
        // 定义联系人信息
        Contact contact = new Contact("java1024","https://www.java1024.xyz", "1250402127@qq.com");
        return new ApiInfoBuilder()
                .title("java1024 SpringBoot") // 标题
                .description("java1024 SpringBoot API信息") // 描述信息
                .version("1.0.0") // //版本
                .license("Apache 2.0")
